                ...
                <a href="{{ route('absensi.index') }}">
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <path
                                d="M15.854 5.146a.5.5 0 0 0-.708 0L13 7.293 11.854 6.146a.5.5 0 1 0-.708.708L12.293 8l-1.147 1.146a.5.5 0 0 0 .708.708L13 8.707l1.146 1.147a.5.5 0 0 0 .708-.708L13.707 8l1.147-1.146a.5.5 0 0 0 0-.708z" />
                            <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm6-5a5 5 0 1 1 0-10 5 5 0 0 1 0 10z" />
                        </svg>
                    </span>
